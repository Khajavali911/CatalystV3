...
public class RestAssuredExtention {
	     ...
	     * @param token
	     */
	    public RestAssuredExtention(String uri, String method, String token) {
	     ...
	     * @return
	     */
	    public ResponseOptions<Response> ExecuteWithOutPathParams() {
	        //builder.addPathParams(pathParams);
	        return ExecuteAPI();
	    }
	    ...
	    public ResponseOptions<Response> DeleteOpsWithPathParams(Map<String, String> pathParams) {
	    	builder.addPathParams(pathParams);
	        return ExecuteAPI();
	    }
	    public ResponseOptions<Response> PostOpsWithBody(Object body)  {
	    	builder.setBody(body);
	        return ExecuteAPI();
	    }
